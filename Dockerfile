...
RUN groupadd -g 25565 minecraft \
	...
	&& curl -o /home/minecraft/bin/server.jar -SLO "http://downloads.sourceforge.net/project/cauldron-unofficial/1.7.10/cauldron-1.7.10-1.1388.1.0-server.jar" \
	&& curl -o /tmp/libraries.zip -SLO "http://downloads.sourceforge.net/project/cauldron-unofficial/1.7.10/libraries-1.1388.1.0.zip" \
